...
const contextSchema = { type: 'object', properties: contextProperties, additionalProperties: false };
const putContextSchema = { type: 'object', properties: {
	...contextProperties, type: { enum: ['fresh', 'messages'] }
...
const TOOLS = [
	...
	{ name: 'notjev_context_put', description: 'Store explicit context once for subsequent decision batches. Returns an expiring immutable reference.',
		inputSchema: { type: 'object', required: ['context'], properties: { context: putContextSchema }, additionalProperties: false } },
